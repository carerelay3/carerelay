  ...
  return (
    <main className="page-shell py-10 sm:py-16">
      ...
      <div className="product-card mt-8 p-6 text-sm sm:p-8" style={{ color: 'var(--text-secondary)' }}>
        ...
        <p>CareRelay is not a medical provider and does not provide medical advice, diagnosis, treatment, medication dosage recommendations, monitoring, or emergency services.</p>
        ...
        <p>CareRelay may categorize or summarize messages, but it does not verify medical truth or evaluate whether information is complete or accurate.</p>
        <p>Service availability is not guaranteed. CareRelay is not an emergency notification system.</p>
