...
export function OnboardingGuide({ onDismiss }: { onDismiss: () => void }) {
  ...
  const steps = [
    { title: "Welcome to CircleRelay", body: "CircleRelay turns scattered group texts into organized updates, tasks, and daily summaries. One shared line keeps the whole circle on the same page." },
    { title: "How it works", body: "Family members text the shared CircleRelay line like they already do. No app install required. The dashboard organizes everything for the person coordinating care." },
    { title: "Try it now", body: "Use the message box above to send a test message. Try 'Need: milk and bread' or 'Mom seemed confused tonight' to see how CircleRelay categorizes and flags messages." },
    ...
    { title: "Safety first", body: "CircleRelay Care Mode is for family coordination only. It does not provide medical advice, diagnosis, monitoring, or emergency services. For emergencies, always call 911." },
