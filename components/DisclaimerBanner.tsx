...
export function DisclaimerBanner({ compact }: Props) {
  return (
    <div className="glass-elevated p-6 relative overflow-hidden transition-all hover:bg-white/40" style={{ border: '1px solid rgba(201,139,90,0.2)' }}>
      ...
      <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center gap-5">
        <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-[1.25rem] shadow-sm" style={{ background: 'var(--warning-soft)' }}>
